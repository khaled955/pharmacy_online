...
export default async function DashboardHomePage() {
  ...
  const [stats, recentOrders] = userId
    ? await Promise.all([getDashboardStats(userId), getRecentOrders(userId, 5)])
  ...
  const statCards: StatCardProps[] = [
    ...
    },
    {
      ...
      subtext:
        stats.wishlistItems > 0 ? "Saved for later" : "Wishlist is empty",
      positive: true,
      icon: Heart,
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border">
                      {["Order ID", "Date", "Product", "Status", "Total"].map(
                        (col) => (
                          <th
                            key={col}
                    ...
                    {recentOrders.map((order) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="max-w-48 px-5 py-4 font-medium text-foreground truncate">
